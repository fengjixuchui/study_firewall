...
Cannot find hal!KeReleaseInStackQueuedSpinLock
   14     0 [  0] nt!NtDeviceIoControlFile
   ...
   24     0 [  5]           nt!ExpLookupHandleTableEntry
   50    24 [  4]         nt!ObpReferenceObjectByHandleWithTag
   56     0 [  5]           nt!ExFastReferenceHandleTableEntry
  121    80 [  4]         nt!ObpReferenceObjectByHandleWithTag
    9     0 [  5]           nt!KeLeaveCriticalRegionThread
  128    89 [  4]         nt!ObpReferenceObjectByHandleWithTag
   14   217 [  3]       nt!ObReferenceObjectByHandle
   30   231 [  2]     nt!IopReferenceFileObject
   87   261 [  1]   nt!IopXxxControlFile
   12     0 [  2]     nt!ObReferenceObjectByHandle
   41     0 [  3]       nt!ObpReferenceObjectByHandleWithTag
   24     0 [  4]         nt!ExpLookupHandleTableEntry
   50    24 [  3]       nt!ObpReferenceObjectByHandleWithTag
   27     0 [  4]         nt!ExFastReferenceHandleTableEntry
   70    51 [  3]       nt!ObpReferenceObjectByHandleWithTag
   15     0 [  4]         nt!ExSlowReplenishHandleTableEntry
  136    66 [  3]       nt!ObpReferenceObjectByHandleWithTag
    9     0 [  4]         nt!KeLeaveCriticalRegionThread
  143    75 [  3]       nt!ObpReferenceObjectByHandleWithTag
   14   218 [  2]     nt!ObReferenceObjectByHandle
   95   493 [  1]   nt!IopXxxControlFile
    8     0 [  2]     nt!KeResetEvent
    5     0 [  3]       hal!KeRaiseIrqlToDpcLevel
   26     5 [  2]     nt!KeResetEvent
  113   524 [  1]   nt!IopXxxControlFile
   10     0 [  2]     nt!IoGetAttachedDevice
  125   534 [  1]   nt!IopXxxControlFile
   10     0 [  2]     nt!IopResetEvent
    5     0 [  3]       hal!KeRaiseIrqlToDpcLevel
   24     5 [  2]     nt!IopResetEvent
  135   563 [  1]   nt!IopXxxControlFile
   11     0 [  2]     nt!IopAllocateIrpExReturn
   65     0 [  3]       nt!IopAllocateIrpPrivate
...
DBGHELP: TCPServer is not source indexed
1: kd> g
794 instructions were executed in 17 events (0 from other threads)

Function Name                               Invocations MinInst MaxInst AvgInst
hal!KeRaiseIrqlToDpcLevel                             2       5       5       5
nt!ExFastReferenceHandleTableEntry                    2      27      56      41
nt!ExInterlockedPopEntrySList                         1       6       6       6
nt!ExSlowReplenishHandleTableEntry                    1      15      15      15
nt!ExpLookupHandleTableEntry                          2      24      24      24
nt!IoGetAttachedDevice                                1      10      10      10
nt!IopAllocateIrpExReturn                             1      11      11      11
nt!IopAllocateIrpPrivate                              1      65      65      65
nt!IopReferenceFileObject                             1      30      30      30
nt!IopResetEvent                                      1      24      24      24
nt!IopXxxControlFile                                  1     135     135     135
nt!KeLeaveCriticalRegionThread                        2       9       9       9
nt!KeResetEvent                                       1      26      26      26
nt!NtDeviceIoControlFile                              1      14      14      14
nt!ObReferenceObjectByHandle                          2      14      14      14
nt!ObpReferenceObjectByHandleWithTag                  2     128     143     135
...
1: kd> bl
     ...
     2 e Disable Clear  00059c14  [C:\Users\刘海龙\Desktop\TCPServer\TCPServer.cpp @ 33]     0001 (0001) TCPServer!main+0xb4
     3 e Disable Clear  819ed600     0001 (0001) nt!NtDeviceIoControlFile
     4 e Disable Clear  76575750     0001 (0001) WS2_32!send
